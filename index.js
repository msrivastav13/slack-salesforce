        ...
        callbackOptions: {
            success: async (installation, installOptions, req, res) => {
                try {
                    ...
                    const salesforce_url = `https://login.salesforce.com/services/oauth2/authorize?client_id=${process.env.SALESFORCE_CLIENT_ID}&redirect_uri=https://94d7e0bbbc0e.ngrok.io/salesforce/oauth_redirect&response_type=code`;
